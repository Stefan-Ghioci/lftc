...
{
       0,    96,    96,    99,   102,   105,   106,   110,   119,   120,
     123,   124,   127,   128,   131,   143,   144,   162,   180,   200,
     220,   240,   262,   268,   277,   282
};
#endif
...
static const char *const yytname[] =
{
  ...
  "SQUARE_LEFT_BRACKET", "SQUARE_RIGHT_BRACKET", "MAIN", "LEFT_ACOL",
  "RIGHT_ACOL", "RETURN", "ID", "CONST", "$accept", "program",
  "begin_prog", "end_prog", "lista_declaratii", "decl", "tip",
  "lista_instr", "instr", "instr_atribuire", "expresie", "instr_io",
  "termen", YY_NULLPTR
};
#endif
...
{
       8,   -18,    17,   -15,    -9,   -30,     0,    -8,   -30,   -30,
     -11,     0,   -16,   -30,    -6,    -5,     4,    -7,   -11,   -30,
     -30,   -30,     1,   -29,   -10,   -29,    -4,    -3,   -30,   -30,
     -30,   -30,     3,     5,     9,   -20,    10,   -30,    11,    12,
     -30,   -29,   -29,   -27,   -25,   -30,   -30,   -30,   -30,   -30,
     -30,   -30,   -30,   -30
};
...
{
       0,     0,     0,     0,     0,     1,     0,     0,     8,     9,
       0,     5,     0,     3,     0,     0,     0,     0,    10,    12,
      13,     6,     0,     0,     0,     0,     0,     0,    11,     7,
      24,    25,     0,     0,     0,    15,     0,     2,     0,     0,
      14,     0,     0,     0,     0,     4,    23,    22,    16,    17,
      18,    19,    20,    21
};
...
{
      14,    15,    35,    41,    42,    43,    44,     8,     9,    30,
      31,    50,    51,    52,    53,     1,     4,     5,    48,    49,
       6,     7,    22,    13,    23,    24,    25,    16,    33,    29,
      26,    21,    28,    37,    38,    36,    39,    40,    45,    46,
      47
};

static const yytype_uint8 yycheck[] =
{
      11,    12,    25,    23,    24,    25,    26,     7,     8,    38,
      39,    38,    39,    38,    39,     7,    34,     0,    41,    42,
      35,    30,    38,    31,    30,    30,    22,    38,    38,    28,
      37,    11,    18,    36,    31,    39,    31,    28,    28,    28,
      28
};
...
{
       0,     7,    41,    42,    34,     0,    35,    30,     7,     8,
      44,    45,    46,    31,    11,    12,    38,    47,    48,    49,
      51,    44,    38,    30,    30,    22,    37,    43,    47,    28,
      38,    39,    52,    38,    50,    52,    39,    36,    31,    31,
      28,    23,    24,    25,    26,    28,    28,    28,    52,    52,
      38,    39,    38,    39
};
...
#line 278 "bison.y" /* yacc.c:1646  */
    {
					...
					strcpy((yyval.attrib).varn, (yyvsp[0].varname));
				}
